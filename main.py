...
from api_routes.mylist_routes import mylist_blueprint
import atexit
...
app.register_blueprint(mylist_blueprint)
...
def swagger_json():
    ...
    endpoint_params = {
            ...
            'GET': {
                'parameters': [
                    ...
                    },
                    {
                        ...
                        'required': False,
                        'type': 'string',
                        'enum': ['mylist', 'requested', 'autogenerated_list'],
                        'description': 'Filter by bucket type. If omitted, all items are returned.'
                    }
                ],
                'tags': ['Shopping Lists'],
                'security': [{'Bearer': []}]
        ...
        '/api/kitchen/generate_autogenerated_list': {
            'POST': {
                'summary': 'Generate autogenerated shopping list',
                'description': (
                    'Builds (or refreshes) the autogenerated shopping list for a kitchen. '
                    ...
                    'Any previous autogenerated_list items for this kitchen are deleted first, '
                    'so this endpoint is always idempotent.\n\n'
                    'Only host or co-host can trigger generation.\n\n'
                    'The generated items are stored with bucket_type="autogenerated_list" and '
                    'can be retrieved via GET /api/kitchen/get_all_mylist_items?bucket_type=autogenerated_list.'
                ),
                'parameters': [{
                    'name': 'body',
                    'in': 'body',
                    ...
                    'schema': {
                        ...
                        'properties': {
                            ...
                            'date': {
                                'type': 'string',
                                'example': '2025-12-25',
                                'description': 'Date (YYYY-MM-DD) used to look up meal plans for missing-ingredient detection'
                            }
                        }
                    }
                }],
                'responses': {
                    '201': {
                        'description': 'Autogenerated list created successfully',
                        'schema': {
                            'type': 'object',
                            'properties': {
                                'message': {'type': 'string'},
                                ...
                                'missing_ingredients_count': {'type': 'integer'},
                                'items': {
                                    'type': 'array',
                                    'items': {
                                        'type': 'object',
                                        'properties': {
                                            ...
                                            'source': {
                                                'type': 'string',
                                                'enum': ['low_stock', 'missing_ingredient']
                                            }
                                        }
                                    }
                                }
                    ...
                    '403': {'description': 'Only host or co-host can generate the list'},
                    '404': {'description': 'Kitchen not found'}
                },
                'tags': ['Shopping Lists'],
                'security': [{'Bearer': []}]
        ...
        '/api/kitchen/edit_mylist_item': {
            'POST': {
                'summary': 'Edit a shopping list item',
                'description': (
                    'Edit any item across all shopping list buckets '
                    '(mylist, requested, autogenerated_list).\n\n'
                    'Permission rules:\n'
                    '- mylist / autogenerated_list items → host or co-host only\n'
                    '- requested items → only the user who created the request\n\n'
                    'At least one of: name, quantity, unit, thumbnail, expiry_date must be provided.'
                ),
                'parameters': [{
                    'name': 'body',
                    'in': 'body',
                    ...
                    'schema': {
                        ...
                        'properties': {
                            ...
                            'item_id': {
                                ...
                                'description': 'UUID hex of the list item to edit'
                            },
                            'name': {
                                'type': 'string',
                                'example': 'Full-fat milk',
                            ...
                            'thumbnail': {
                                ...
                                'description': 'Base64 image (optional; pass null to clear)'
                            },
                            'expiry_date': {
                                'type': 'string',
                                'example': '7 days',
                                'description': 'Expiry duration string (optional; pass null to clear)'
                            }
                        }
                    }
                }],
                'responses': {
                    ...
                    '404': {'description': 'Kitchen or item not found'}
                },
                'tags': ['Shopping Lists'],
                'security': [{'Bearer': []}]
            }
